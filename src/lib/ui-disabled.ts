...
export const uiDisabledLabel =
  "group-data-disabled:pointer-events-none group-data-disabled:text-disabled-foreground peer-disabled:pointer-events-none peer-disabled:text-disabled-foreground peer-data-disabled:pointer-events-none peer-data-disabled:text-disabled-foreground peer-disabled:cursor-not-allowed peer-data-disabled:cursor-not-allowed"
