...
export const GRAYSCALE_SCALE: GrayscaleStep[] = [
  ...
  { name: "grayscale-100", variable: "--grayscale-100", hex: "#636366", role: "스케일 스텝" },
  { name: "grayscale-110", variable: "--grayscale-110", hex: "#535356", role: "foreground-muted · inverse-muted · 보더" },
