  ...
  return (
    <div className={cn(previewShell, "px-2")}>
      <Card className="w-full max-w-[200px] py-3 shadow-none">
        ...
        <CardContent className="px-3 pt-2 text-xs text-muted-foreground">
          본문 영역
        </CardContent>
      </Card>
    </div>
...
function PreviewDropdownMenu() {
  return (
    <div className={previewShell}>
      <div className="flex min-w-36 flex-col overflow-hidden rounded-lg border border-border bg-popover text-sm shadow-md">
        <div className="px-3 py-2 font-medium">메뉴</div>
        <Separator />
        <div className="px-3 py-1.5 text-muted-foreground">항목 1</div>
        <div className="bg-accent px-3 py-1.5 font-medium text-accent-foreground">항목 2</div>
        <div className="px-3 py-1.5 text-muted-foreground">항목 3</div>
      </div>
    </div>
  )
}
  ...
  return (
    <div className={previewShell}>
      <div className="w-full max-w-[200px] rounded-xl border border-border bg-card p-4 shadow-md">
        ...
        <p className="mt-1 text-xs text-muted-foreground">모달 콘텐츠 영역</p>
    ...
    <div className={cn(previewShell, "px-2")}>
      <div className="w-full max-w-[220px] rounded-lg border border-border bg-background text-sm">
        <div className="flex items-center justify-between border-b border-border px-3 py-2 font-medium">
          섹션 1
          <Icon icon={ICONS.chevronDown} size="sm" className="text-muted-foreground" />
        </div>
        <div className="px-3 py-2 text-xs text-muted-foreground">내용</div>
...
function PreviewSeparator() {
  return (
    <div className={cn(previewShell, "flex-col gap-3 px-6")}>
      <span className="text-xs text-muted-foreground">위 콘텐츠</span>
      <Separator />
      <span className="text-xs text-muted-foreground">아래 콘텐츠</span>
    </div>
  )
}
