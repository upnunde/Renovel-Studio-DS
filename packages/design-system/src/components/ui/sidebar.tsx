...
const sidebarMenuButtonVariants = cva(
  `group/sidebar-menu-button peer/menu-button flex w-full cursor-pointer items-center gap-3 rounded-md text-left outline-none transition-colors duration-short ease-standard focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${uiDisabledInteractive} [&_svg]:pointer-events-none [&_svg]:shrink-0`,
  {
    variants: {
      size: {
        /** 앱 내비 · 장면 목록 기본 */
