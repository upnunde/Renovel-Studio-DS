...
/** 합본 타이포 38토큰 — typography.css @utility 와 단일 소스 */
export const TYPOGRAPHY_SCALE: TypographyToken[] = [
  ...
  { className: "text-heading1_600", label: "32_38", group: "heading", rank: 1, fontSizePx: 32, lineHeightPx: 38, fontWeight: 600, description: "페이지 최상단 타이틀 (semibold)" },
  ...
  { className: "text-heading2_600", label: "24_34", group: "heading", rank: 2, fontSizePx: 24, lineHeightPx: 34, fontWeight: 600, description: "페이지 타이틀 (semibold)" },
  ...
  { className: "text-heading3_600", label: "22_30", group: "heading", rank: 3, fontSizePx: 22, lineHeightPx: 30, fontWeight: 600, description: "섹션 타이틀 (semibold)" },
  ...
  { className: "text-heading4_600", label: "20_28", group: "heading", rank: 4, fontSizePx: 20, lineHeightPx: 28, fontWeight: 600, description: "섹션 서브타이틀 (semibold)" },
  ...
  { className: "text-heading5_600", label: "18_26", group: "heading", rank: 5, fontSizePx: 18, lineHeightPx: 26, fontWeight: 600, description: "카드/모달 타이틀 (semibold)" },
  ...
  { className: "text-body1_600", label: "16_24", group: "body", rank: 1, fontSizePx: 16, lineHeightPx: 24, fontWeight: 600, description: "본문 강조 (semibold)" },
  ...
  { className: "text-body2_600", label: "15_22", group: "body", rank: 2, fontSizePx: 15, lineHeightPx: 22, fontWeight: 600, description: "본문 (semibold)" },
  ...
  { className: "text-body3_600", label: "14_20", group: "body", rank: 3, fontSizePx: 14, lineHeightPx: 20, fontWeight: 600, description: "기본 텍스트 (semibold)" },
  ...
  { className: "text-body4_600", label: "13_18", group: "body", rank: 4, fontSizePx: 13, lineHeightPx: 18, fontWeight: 600, description: "보조 텍스트 (semibold)" },
  ...
  { className: "text-caption1_600", label: "12_16", group: "caption", rank: 1, fontSizePx: 12, lineHeightPx: 16, fontWeight: 600, description: "라벨/메타 (semibold)" },
  ...
  { className: "text-caption2_600", label: "11_14", group: "caption", rank: 2, fontSizePx: 11, lineHeightPx: 14, fontWeight: 600, description: "최소 라벨 (semibold)" },
